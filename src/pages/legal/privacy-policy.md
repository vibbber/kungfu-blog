...
- Referring URLs
- Cookies and similar identifiers (see our [Cookie Policy](/legal/cookie-policy))
...
To provide personalized guidance, your child's profile data and your conversation content are sent to third-party AI service providers for processing. These providers generate responses in real-time and do not retain your data for their own model training (see [Sub-Processors](/legal/sub-processors) for details and our zero-retention configuration).
...
A current list of our AI and infrastructure sub-processors is maintained at [Sub-Processors](/legal/sub-processors).
...
Vibbber Tech FCZO is based in Dubai, United Arab Emirates. Your data may be transferred to and processed in countries other than your own, including the UAE and countries where our sub-processors operate (see [Sub-Processors](/legal/sub-processors)).
